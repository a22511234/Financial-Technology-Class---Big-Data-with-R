...
itemFrequencyPlot(nw,topN=25,col=rainbow(10)) # result- Figure 2 Item frequency bar plot
itemFrequencyPlot(nw,support=0.02,col=rainbow(10))
# step 6.
# mine association rules
# rules <- apriori(nw) # Mine association rules using default Apriori algorithm
rules1 <- apriori(nw, parameter = list(supp = 0.001, target = "maximally frequent itemsets")) # set parameters
